...
class BranchSettingsForm_Admin(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['voice_volume'] = forms.fields.IntegerField(label='Voice volume', help_text=self.fields['voice_volume'].help_text)
        ...
        self.fields['bookingForceOnTime'] = forms.fields.BooleanField(label='Enable Booking force on time', required=False, help_text=self.fields['bookingForceOnTime'].help_text)
...
class BranchSettingsForm_Adv(ModelForm):
    ...
    voiceenabled = forms.fields.BooleanField(label='Enable Voice announcement', required=False)
    voice_volume = forms.fields.IntegerField(label='Voice volume')
    language1 = forms.fields.CharField(label='First Language (0-4), 0 is not used')
