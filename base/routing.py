...
websocket_urlpatterns = [
    ...
    re_path(r'ws/{}/voice840/(?P<bcode>\w+)/(?P<ct>\w+)/$'.format(APP_NAME), consumers.Voice840Consumer.as_asgi()),
    ...
    re_path(r'ws/{}/disp840/(?P<bcode>\w+)/(?P<ct>\w+)/$'.format(APP_NAME), consumers.DispPanelConsumer840.as_asgi()),
