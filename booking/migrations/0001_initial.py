# Generated by Django 4.2.10 on 2024-02-21 10:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('new', 'New booking'), ('confirmed', 'Confirmed'), ('completed', 'Completed'), ('late', 'Late'), ('noshow', 'Customer No show'), ('rejected', 'Rejected by Admin'), ('cancelled', 'Cancelled by Customer')], default='new', max_length=100, null=True, verbose_name='Booking Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('new', 'New'), ('change', 'Change'), ('cancel', 'Cancel'), ('confirm', 'Confirm'), ('reject', 'Reject'), ('noshow', 'No show'), ('complete', 'Completed'), ('delete', 'Delete')], default='new', max_length=100, verbose_name='Time Slot Action')),
                ('status', models.CharField(blank=True, default=django.db.models.deletion.SET_NULL, max_length=100, null=True, verbose_name='Booking Status')),
